...
<!-- Mirrored from themesflat.com/html/educate/index-onepage.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 May 2017 15:51:32 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
    ...
    <!-- Colors -->
    <?= $this->Html->css("colors/color1.css",["id"=>"colors"]); ?>
    <!-- Animation Style -->
...
<body class="header-sticky page-template-front-page">
    <div class="boxed">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="right-bar">
                                <ul class="flat-information">
                                    <li class="phone">
                                        <a href="%2b61383766284.html" title="Phone number">0084 - 9622 26602</a>
                                    </li>
                                    <li class="email">
        ...
        <div id="rev_slider_1078_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="classic4export" data-source="gallery" style="margin:0px auto;background-color:transparent;padding:0px;margin-top:0px;margin-bottom:0px;">
            ...
            <div id="rev_slider_1078_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
                <ul><!-- SLIDE  -->
                    ...
                    <!-- SLIDE 2 -->
                    <li data-index="rs-3048" data-transition="zoomout" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="assets/img/fitness-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="HTML5 Video" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="img/slides/1.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->                        
                        ...
                        <div class="tp-caption title-slide" 
                            ...
                            style="z-index: 16; white-space: nowrap;text-transform:left;">EDUCATE HTML TEMPLATES </div>
                        ...
                        data-voffset="83" 
                        data-width="['173']"
                        data-height="['50']">START A COURSE
                        </a><!-- END LAYER LINK -->

                        <a href="http://www.themepunch.com/" target="_self" class="tp-caption flat-button-slider"   

                        data-frames='[{"delay":2000,"speed":2000,"frame":"0","from":"x:50px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"x:50px;opacity:0;","ease":"Power3.easeInOut"}]'
                        ...
                        data-voffset="83" 
                        data-width="['150']"
                        data-height="['50']">TAKE A TOUR
                        </a><!-- END LAYER LINK -->
                    </li>
            
                    <!-- SLIDE 1 -->
                    <li data-index="rs-3047" data-transition="zoomin" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="assets/img/bike-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Ken Burns" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">

                        <!-- MAIN IMAGE -->
                        <img src="img/slides/1.jpg"  alt=""  data-bgposition="center center" data-kenburns="on" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                    ...
                    <!-- SLIDE 3 -->
                    <li data-index="rs-3049" data-transition="zoomin" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="assets/img/lambo-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Love it?" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="img/slides/1.jpg"  alt=""  data-bgposition="center center" data-kenburns="on" data-duration="10000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 -500" data-offsetend="0 500" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
        ...
        <div id="about" class="flat-row course row-bg">
            <div class = "container">
                <div class="row">
                    <div class="col-md-7 col-sm-12 flat-pdr-100">                       
                        <h1 class="title-course">Choose The Design Tool You Want To Learn</h1>
                        ...
                        <div class="flat-button-container">
                            <a class="flat-button orange" href="courses.html">VIEW ALL COURES</a>
                        </div> 
                    </div>
                    ...
                    <div class="col-md-5 col-sm-12"> 
                        <ul class = "flat-course-images">
                            <li>
                                <img src="img/index/Cate-01.jpg" alt="Cate-01"/>
                            </li>

                            <li>
                                <img src="img/index/Cate-02.jpg" alt="Cate-02"/>
                            </li>

                            <li>
                                <img src="img/index/Cate-03.jpg" alt="Cate-03"/>
                            </li>

                            <li>
                                <img src="img/index/Cate-04.jpg" alt="Cate-04"/>
                            </li>

                            <li>
                                <img src="img/index/Cate-05.jpg" alt="Cate-05"/>
                            </li>

                            <li>
                                <img src="img/index/Cate-06.jpg" alt="Cate-06"/>
                            </li>
                        </ul>  
                    </div>                    
        ...
        <div id="courses" class = "flat-row popular-course">
            <div class="container">
                ...
                <div class="flat-course-grid button-right">
                    <div class="flat-course">
                        <div class="featured-post">             
                            ...
                            <a href="courses-single.html"><img src="img/index/course1.jpg" alt="Course1"></a>
                        </div><!-- /.featured-post -->
                    ...
                    <div class="flat-course">
                        <div class="featured-post">             
                            ...
                            <a href="courses-single.html"><img src="img/index/course2.jpg" alt="Course1"></a>
                        </div><!-- /.featured-post -->
                    ...
                    <div class="flat-course">
                        <div class="featured-post">             
                            ...
                            <a href="courses-single.html"><img src="img/index/course3.jpg" alt="Course1"></a>
                        </div><!-- /.featured-post -->
        ...
        <div id="blog" class = " flat-row lastest-new">
            <div class="container">
                <div class="flat-title-section">
                ...
                <div class="row post-lastest-new">
                    <div class="post col-md-4 col-xs-12 col-sm-6 flat-hover-zoom">
                        <div class="featured-post">
                            <div class="entry-image">
                                <img src="img/blog/Blog-02.jpg" alt="image">
                            </div>
                        </div>
                    ...
                    <div class="post col-md-4 col-xs-12 col-sm-6 flat-hover-zoom">
                        <div class="featured-post">
                            <div class="entry-image">
                                <img src="img/blog/Blog-03.jpg" alt="image">
                            </div>
                        </div>
        ...
        <section class="flat-row partners">
            <div class="container">
                <ul class="partners-slider">
                    <li>
                        <img alt="owlcarousel-item-img" src="img/clients/Logo-01.jpg"/>
                    </li>
                    <li>
                        <img alt="owlcarousel-item-img" src="img/clients/Logo-02.jpg"/>
                    </li>
                    <li>
                        <img alt="owlcarousel-item-img" src="img/clients/Logo-03.jpg"/>
                    </li>
                    <li>
                        <img alt="owlcarousel-item-img" src="img/clients/Logo-04.jpg"/>
                    </li>
                    <li>
                        <img alt="owlcarousel-item-img" src="img/clients/Logo-05.jpg"/>
                    </li>
                    <li>
                        <img alt="owlcarousel-item-img" src="img/clients/Logo-06.jpg"/>
                    </li>
                </ul>
            </div>
        </section>

        <section id="team" class="flat-row testimonial">
            <div class="container">
        ...
        <section id="contact" class="flat-row news-letter">
            <div class="container">
    ...
    <?= $this->Html->script("../revolution/js/slider.js"); ?>
